                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="shippingAddress">Shipping address is the
                                                same as my billing address</label>
                                        </div>
                                        <!-- Checkbox  -->
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="saveCard" required />
                                            <label class="form-check-label" for="saveCard">Save this information for next
                                                time</label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <label class="d-flex justify-content-between align-items-center form-label"
                                            ...
                                            <span>
                                                <svg width="18" height="18" aria-hidden="true" focusable="false"
                                                    data-prefix="fab" data-icon="cc-amex"
                                                ...
                                                <svg width="18" height="18" aria-hidden="true" focusable="false"
                                                    data-prefix="fab" data-icon="cc-mastercard"
                                                    class="svg-inline--fa fa-cc-mastercard text-primary" role="img"
                                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                                    <path fill="currentColor"
                                                ...
                                                <svg width="18" height="18" aria-hidden="true" focusable="false"
                                                    data-prefix="fab" data-icon="cc-discover"
                                                    class="svg-inline--fa fa-cc-discover text-primary" role="img"
                                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                                    <path fill="currentColor"
                                                ...
                                                <svg width="18" height="18" aria-hidden="true" focusable="false"
                                                    data-prefix="fab" data-icon="cc-visa"
